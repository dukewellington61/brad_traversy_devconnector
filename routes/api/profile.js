...
router.put('/experience', [auth, [
    ...
    const errors = validationResult(req);
    if (!errors.isEmpty) {
        return res.status(400).json({ errors: errors.aeeay() });
    };
    ...
    try {
        ...
        profile.experience.unshift(newExp); /* unshift pushes element to beginning of array */
...
router.put('/education', [auth, [
    ...
    try {
        ...
        profile.education.unshift(newEdu); /* unshift pushes element to beginning of array */
